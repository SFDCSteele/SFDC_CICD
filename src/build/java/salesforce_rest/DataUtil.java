...
public class DataUtil {
    ...
    private static String REST_ENDPOINT = "/services/data/v47.0/query/";
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("==========================================\DataUtil version: " + RUN_VERSION +
                " run option: " + args[0] + "\n==========================================");
    ...
    public static void submitBuildStatus(String[] args) {
        ...
        try {
            ...
            for (int i=0,j=0;i<packageXMLs.size();i++ ) {
                if(DEBUG_ON) System.out.println("DataUtil: submitBuildStatus: package.xml: "+packageXMLs.get(i));
    ...
    private static List<String> loadPackageXMLs (String[] args) {
        ...
        if (deployType.equals("FULL")) {
            ...
            if(DEBUG_ON) System.out.println("2-DataUtil: loadPackageXMLs: package.xml: "+inputFile.getName());
        }
        return packageXMLs;
    }
